...
public class ItemPlateRed extends ItemArmor implements IArmorTextureProvider {

	public ItemPlateRed(int par1, EnumArmorMaterial par2EnumArmorMaterial,
			int par3, int par4) {
	...
	public void updateIcons(IconRegister par1IconRegister) {
		this.iconIndex = par1IconRegister.registerIcon("MerlinsLegacy:PlateR");
	}
}
