...
public class ItemBootsPurple extends ItemArmor implements IArmorTextureProvider {

	public ItemBootsPurple(int par1, EnumArmorMaterial par2EnumArmorMaterial,
			int par3, int par4) {
	...
	@SideOnly(Side.CLIENT)
	 ...
	 {
	   this.iconIndex = par1IconRegister.registerIcon("MerlinsLegacy:BootsP");
     }
